...
CREATE TABLE IF NOT EXISTS Usuario (
    ...
    generos_seleccionados VARCHAR(255) -- Almacena los géneros seleccionados como una lista de IDs
);
...
-- Insertar usuarios (Ajustado)
INSERT INTO Usuario (nombre, apellido, correo_electronico, fecha_nacimiento, nombre_usuario, clave, dni, generos_seleccionados) 
VALUES 
('John', 'Doe', 'john.doe@example.com', '1990-05-15', 'johndoe', '123456', 12345678, '1,2'),
('Jane', 'Smith', 'jane.smith@example.com', '1985-08-23', 'janesmith', 'abcdef', 87654321, '3,4');
